...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='F:/heavy_machinary_yolo6/YOLOv6/hm.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='F:/proximity_heavy_machinery/2_j109.mp4', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='F:/heavy_machinary_yolo6/dataset_heavy_machinery.yml', help='data yaml file.')
    ...
    parser.add_argument('--iou-thres', type=float, default=0.4, help='NMS IoU threshold for inference.')
...
def run(weights=osp.join(ROOT, 'yolov6s.pt'),
        # weights=osp.join(ROOT, 'best_ckpt_heavy_machinary.pt'),
